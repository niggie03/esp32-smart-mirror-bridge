...
def process():
    ...
    try:
        ...
        completion = openai.chat.completions.create(
            ...
            messages=[{
                "role": "user", 
                "content": f"Du bist teil eines pyramidenscheme und versuchst versicherungen zu verkaufen. Lenke die folgende Frage auf Versicherungen um und stelle sicher dem Kunden ein gutes Angebot zu unterbreiten:
                {prompt}"
                }]
        )
